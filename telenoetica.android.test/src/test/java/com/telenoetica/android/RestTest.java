...
public class RestTest {
	...
	public void test1(){
		try {
			AppValuesPopulator.populateValues();
	...
	public void test2(){
		...
		RestResponse restResponse = RestClient.INSTANCE.executePost("http://localhost:8080/fieldapp/routine/rest", obj);
